            ...
            <div class="row gx-5 justify-content-center">
                <div class="col-xxl-10">
                        ...
                        <div class="row g-4 justify-content-center">
                            ...
                            <div class="col-md-4">
                                <div class="card border-0 shadow rounded-4 h-100 p-4">
                                    <div
                                        class="feature bg-primary bg-gradient-primary-to-secondary text-white rounded-3 mb-4">
                                        <i class="bi bi-code-square"></i>
                                    </div>
                                    <h4 class="fw-bolder">Web Development</h4>
                                    <p class="text-muted small">Specializing in Laravel, I build scalable, high-performance
                                        web applications with clean, maintainable code.</p>
                                </div>
                            </div>
                            <!-- Service 2 -->
                            <div class="col-md-4">
                                <div class="card border-0 shadow rounded-4 h-100 p-4">
                                    ...
                                    <p class="text-muted small">Designing robust RESTful APIs that power modern mobile and
                                        web experiences with security and speed.</p>
                                </div>
                            </div>
                            <!-- Service 3 -->
                            <div class="col-md-4">
                                <div class="card border-0 shadow rounded-4 h-100 p-4">
                                    ...
                                    <p class="text-muted small">Expertise in MySQL and database architectural design to
                                        ensure data integrity and optimized performance.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="text-center my-5">
                        ...
                        <p class="lead fw-light mb-4">I am a passionate and results-driven <strong>Sr. PHP/Laravel
                                Developer</strong> with over 2 years of professional experience building dynamic, secure,
                            and scalable web applications.</p>
                        <p class="text-muted">My technical expertise spans the full development lifecycle, from designing
                            robust back-end architectures to crafting responsive, user-friendly interfaces. I am also an AI
                            Prompt Engineer, leveraging AI to solve complex problems efficiently.</p>
                        <div class="d-flex justify-content-center fs-2 gap-4">
                            <a class="text-gradient hover-scale" href="https://wa.me/923017730687?text=Hello%20Afaq%20Tahir"
                                target="_blank"><i class="bi bi-whatsapp"></i></a>
                            <a class="text-gradient hover-scale" href="https://linkedin.com/in/afaq-tahir0687"
                                target="_blank"><i class="bi bi-linkedin"></i></a>
                            <a class="text-gradient hover-scale" href="https://github.com/afaqtahir0687" target="_blank"><i
